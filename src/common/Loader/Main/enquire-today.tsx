  ...
  return <div className="flex flex-col px-10">
    ...
    <div className="flex mb-6">
      ...
      <div className="flex flex-col text-lg">
        <p className="mb-3">
          For a no obligation quote please call us today on <Link className='text-meta-5 hover:underline' to='tel:+441316699993'>0131 669 9993</Link> or complete the form below.
        </p>
