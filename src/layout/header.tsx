...
export const Header: FC = () => {
  ...
  return (
    <div className="flex w-full py-2 px-8 lg:pl-16 h-fit font-bold">
      ...
      <div id='navBar' className="lg:hidden fixed block left-0 top-[4.5rem] bottom-0 w-80 bg-white px-0 py-3">
        {navLinks.map((item, index) => (
      ...
      <div className="flex mr-0 ml-auto self-center">
        <a href="tel:01162345897"><Button variant="contained" color="secondary" className="flex-col">
          <div>Call us today</div>
          <div className="flex"><HiPhone className="mt-1 mr-1" /><span>01162345897</span></div>
        </Button></a>
      </div>
    </div>
  )
