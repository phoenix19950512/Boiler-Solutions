...
import CoverOne from '/media/images/profile-landing.jpg';
  ...
  return (
    <div className='m-8'>
      ...
      <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="relative z-20 h-35 sm:h-80 md:h-115 lg:h-150">
          <img
            src={CoverOne}
            alt="profile cover"
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="mt-4">
            ...
            <div className="mx-auto max-w-180 text-black dark:text-white">
              <b>Email Addreess:</b> {currentUser?.email ?? ''}
            </div>
            <div className="mx-auto max-w-180 text-black dark:text-white">
