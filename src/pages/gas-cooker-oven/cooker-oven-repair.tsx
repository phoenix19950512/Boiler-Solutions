  ...
  return (
    <>
      ...
      <p className="text-base mb-3 leading-8">
        Are you experiencing problems with your gas cooker?<br />
        Whatever is wrong with your gas cooker, we are sure our engineer will be able to help!<br />
        ...
        However, should the engineer not have the required part, he will place an order with their trusted suppliers and arrange a convenient time to return to your property to complete the job.<br />
        To give you piece of mind, all our engineers are Gas Safe Registered.<br />
        This means that they are fully trained and experienced, so any work we carry out will be certified as safe.
        With nearly 20 years experience in the industry, you can be certain that you are in safe hands.<br />
