  ...
  return (
    <>
      ...
      <p className="text-base mb-3 leading-8">
        AF Boiler Solutions are dedicated to providing our customers with a friendly service of the highest quality.<br />
        ...
        This enables us to make sure that your new cooker or oven is fully functioning and completely safe to use.<br />
        ...
        Regardless of the brand, your new appliance will be expertly installed with absolute precision and with your safety in mind.<br />
