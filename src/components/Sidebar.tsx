...
import { useAuth } from '../pages/Authentication/AuthHelpers';
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <img src='/media/images/logo.png' alt="Logo" className='h-16 invert' />
        </NavLink>
        ...
        <nav className="mt-0 pb-4 px-4 lg:px-6">
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
              <SidebarLinkGroup activeCondition={pathname === '/boiler' || pathname.includes('boiler')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/boiler' ||
                          pathname.includes('boiler')) &&
                      ...
                      >
                        <svg
                          ...
                          className="fill-current"
                        >
                          <path d="M12 2C9.243 2 7 4.243 7 7v10c0 2.757 2.243 5 5 5s5-2.243 5-5V7c0-2.757-2.243-5-5-5zM9 7c0-1.654 1.346-3 3-3s3 1.346 3 3v10c0 1.654-1.346 3-3 3s-3-1.346-3-3V7zm4 9h-2v-2h2v2zm0-4h-2v-2h2v2zm0-4h-2V6h2v2z" />
                        </svg>
                        Boilers
                        <svg
              ...
              <SidebarLinkGroup activeCondition={pathname === '/plumbing' || pathname.includes('plumbing')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/plumbing' ||
                          pathname.includes('plumbing')) &&
                          'bg-graydark dark:bg-meta-4'
                          }`}
                        onClick={(e) => {
                          e.preventDefault();
                      ...
                      >
                        <svg
                          ...
                          xmlns="http://www.w3.org/2000/svg"
                        >
                          <path d="M19.5 6.5a2.5 2.5 0 00-3.54 0l-1.32 1.33a2.5 2.5 0 00-3.54 0L8.5 10.42 7.08 9l1.66-1.66a.75.75 0 00-1.06-1.06l-1.66 1.66a2.5 2.5 0 000 3.54L7.5 14.5 3.21 18.79a1 1 0 101.42 1.42l4.29-4.29 1.94 1.94a2.5 2.5 0 003.54 0l2.59-2.59a2.5 2.5 0 000-3.54l1.33-1.32a2.5 2.5 0 000-3.54z" />
                        </svg>
                        Plumbing
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${open && 'rotate-180'
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/plumbing/repair-replace"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                            >
                              Tap Repaire & Replacements
                            </NavLink>
                          </li>
                          <li>
                            <NavLink
                              to="/plumbing/mains-water-stopcock"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
              ...
              <SidebarLinkGroup activeCondition={pathname === '/gas-fire' || pathname.includes('gas-fire')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/gas-fire' ||
                          pathname.includes('gas-fire')) &&
                          'bg-graydark dark:bg-meta-4'
                          }`}
                        onClick={(e) => {
                          e.preventDefault();
                      ...
                      >
                        <svg
                          ...
                          xmlns="http://www.w3.org/2000/svg"
                        >
                          <path d="M12 2C10.4 2 8.9 3.1 8.4 4.6c-.3.8-.5 1.7-.5 2.6C7.9 10.1 5 12.9 5 16c0 3.3 2.7 6 6 6s6-2.7 6-6c0-3.1-2.9-5.9-2.9-8.8 0-.9-.2-1.8-.5-2.6C15.1 3.1 13.6 2 12 2zm0 18c-2.2 0-4-1.8-4-4 0-1.8 1.7-3.2 3.7-5.6.3.6.8 1.4 1.1 2.2 1.1 2.1 1.2 3.4 1.2 3.4s1.7 0 1.7-2.7c0-.9-.5-1.7-.9-2.4.2 1.3 1.1 2.7 1.1 4.1 0 2.2-1.8 4-4 4z" />
                        </svg>
                        Gas Fires
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${open && 'rotate-180'
              ...
              <SidebarLinkGroup activeCondition={pathname === '/gas-cooker-oven' || pathname.includes('gas-cooker-oven')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/gas-cooker-oven' ||
                          pathname.includes('gas-cooker-oven')) &&
                          'bg-graydark dark:bg-meta-4'
                          }`}
                        onClick={(e) => {
                          e.preventDefault();
                      ...
                      >
                        <svg
                          ...
                          xmlns="http://www.w3.org/2000/svg"
                        >
                          <path d="M19 2H5c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM5 20V4h14v16H5zm2-3h10v2H7v-2zm1-5h2v3H8v-3zm4 0h2v3h-2v-3zm4 0h2v3h-2v-3z" />
                        </svg>
                        Gas Cookers & Ovens
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${open && 'rotate-180'
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/gas-cooker-oven/cooker-oven-repair"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                          ...
                          <li>
                            <NavLink
                              to="/gas-cooker-oven/cooker-oven-install"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                            >
                              Cooker & Oven Installations
                            </NavLink>
                          </li>
                        </ul>
                      </div>
              ...
              <SidebarLinkGroup activeCondition={pathname === '/landlords' || pathname.includes('landlords')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/landlords' ||
                      ...
                      >
                        <svg
                          ...
                          xmlns="http://www.w3.org/2000/svg"
                        >
                          <path d="M12 2L2 7v15h6V9h8v13h6V7L12 2zm0 7H7v11h2v-9h6v9h2V9h-5zm0-5.65L17.03 7H6.97L12 3.35z" />
                        </svg>
                        Landlords
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${open && 'rotate-180'
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/landlords/certification-service"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
              ...
              <SidebarLinkGroup activeCondition={pathname === '/central-heating' || pathname.includes('central-heating')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/central-heating' ||
                          pathname.includes('central-heating')) &&
                          'bg-graydark dark:bg-meta-4'
                          }`}
                        onClick={(e) => {
                          e.preventDefault();
                      ...
                      >
                        <svg
                          ...
                          xmlns="http://www.w3.org/2000/svg"
                        >
                          <path d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm0 18c-1.47 0-2.84-.4-4.01-1.09l8.92-8.92A7.978 7.978 0 0 1 12 20zM5.09 14A7.978 7.978 0 0 1 12 4c1.47 0 2.84.4 4.01 1.09L7.09 14zm2.83 2.83A8.014 8.014 0 0 1 4 12a8.014 8.014 0 0 1 3.92-6.83L12 12l-4.08 4.08z" />
                        </svg>
                        Central Heating
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${open && 'rotate-180'
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/central-heating/repair-replace"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
              ...
              <li>
                <NavLink
                  to="/power-flushing"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('power-flushing') && 'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <svg
                    className="fill-current"
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 15h-2v-2h2v2zm0-4h-2v-2h2v2zm6-2h-2v2h2v-2zm0-4h-2v2h2V7z" />
                  </svg>
                  Power Flushing
                </NavLink>
              </li>
                ...
                >
                  ...
                  >
                    <path
                      ...
                      d="M3 3h2l.4 2m0 0L8 15h10l2-7H7.4m-2 0l-.4-2M9 20.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zm10 0a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z"
                    />
                  </svg>
                  Orders
                </NavLink>
