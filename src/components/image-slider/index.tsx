...
export const ImageSlider: FC = () => {
  ...
  const firstSlide = document.querySelector('#firstSlide') as HTMLDivElement;
  ...
  }, [firstSlide?.style.marginLeft, slideArr.length]);

  return <>
    <div className="relative w-full h-full box-border m-0 p-0 flex items-center overflow-hidden bg-black">
